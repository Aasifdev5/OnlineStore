    ...
    @foreach ($categories as $parentCategory)
        <li class="categories__shop--card" style="width: 150px; height: 150px; display: flex; flex-direction: column; justify-content: space-between;">
            <a class="categories__shop--card__link" href="{{ url('productbySubCategory') }}/{{ $category }}/{{ $parentCategory->id }}">
                ...
                <div class="categories__content" style="text-align: center; flex-grow: 1;">
                    <h2 class="categories__content--title" style="font-size: 12px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $parentCategory->name }}</h2>
                    <span class="categories__content--subtitle" style="font-size: 10px;">
                        @php

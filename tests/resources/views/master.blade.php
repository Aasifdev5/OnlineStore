...
<script>
    ...
    function formatDateToUTC(date) {
        return date.toISOString(); // Formats date as UTC
    }
    ...
    function resetActivityTimer() {
        ...
        console.log('Activity detected, timer reset at (UTC):', formatDateToUTC(new Date(Date.now())));
    }

    function handleVisibilityChange() {
        if (document.visibilityState === 'visible') {
            resetActivityTimer(); // Reset timer when the page becomes visible again
            console.log('Page is visible, timer reset at (UTC):', formatDateToUTC(new Date(Date.now())));
        } else {
    ...
    function performLogout() {
        console.log('Performing logout at (UTC):', formatDateToUTC(new Date(Date.now())));

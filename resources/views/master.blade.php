                ...
                <div class="header__bottom--inner position__relative d-flex align-items-center">
                    <div class="categories__menu mobile-v-none">
                        ...
                        {{-- @php
                            dd($_SERVER);
                        @endphp --}}
                        <div class="dropdown__categories--menu border-radius-5 active collapse @if ($_SERVER['REQUEST_URI'] == '/')
  show
                    ...
                    <div class="header__right--area d-flex justify-content-between align-items-center">
                        <div class="header__menu">
                            <nav class="header__menu--navigation">
                                <ul class="header__menu--wrapper d-flex">
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white active" href="{{ url('/') }}">Home
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__widget--menu footer__widget--inner">
                                ...
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('dashboard') }}">My Account</a></li>
                                @else
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('Userlogin') }}">My Account</a></li>
                                @endif
        ...
        <div class="footer__bottom">
            <div class="container">
                <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                    ...
                    <p class="copyright__content"><span class="text__secondary">© 2024</span>  All Rights Reserved.</p>

                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1-slider1-bg">
                            ...
                            <div class="hero__slider--layer">
                                <img class="slider__layer--img " src="assets/img/slider/home1-slider1-layer.webp" alt="slider-img">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1-slider1-bg">
                            ...
                            <div class="hero__slider--layer">
                                <img class="slider__layer--img " src="assets/img/slider/home1-slider2-layer.webp" alt="slider-img">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1-slider1-bg">
                            ...
                            <div class="hero__slider--layer">
                                <img class="slider__layer--img " src="assets/img/slider/home1-slider3-layer.webp" alt="slider-img">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb--n25">
                <div class="col-lg-2 col-md-4 col-sm-4 col-6 mb-25">
                    <div class="categories__card text-center">
                        <a class="categories__card--link" href="{{url('shop')}}">
    ...
    <section class="discount__banner--section section--padding pt-0">
        <div class="container">
            <div class="discount__banner--thumbnail">
                <a class="display-block position-relative" href="#"><img class="discount__banner--thumbnail__img" src="assets/img/banner/discount-bg.webp" alt="banner-img">
                                ...
                                <ul class="choose__category--menu">
                                    <li class="choose__category--menu__list">
                                        ...
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                         ...
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Engine Partses</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Replacement Parts</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Oiles Fluids</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Medical Equipment</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Oil & lubricantss</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Car & Motobike Care</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Car care kits</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Brake disks & pads</a>
                                    </li>
                                    <li class="choose__category--menu__list">
                                        <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z" fill="currentColor"/>
                                        </svg>
                                         <a class="choose__category--menu__link" href="{{url('shop')}}">Inhaler Pressure Drop</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="choose__category--banner position__relative">
                                <a class="banner__thumbnail display-block" href="{{url('shop')}}"><img class="banner__thumbnail--img" src="assets/img/banner/banner3.webp" alt="banner-img">
                            ...
                            <div class="small__product--inner product__swiper--column1 swiper">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="small__product--card d-flex">
                                            <div class="small__product--thumbnail">
                                                <a class="display-block" href="product-details.html"><img src="assets/img/product/small-product/product9.webp" alt="product-img"></a>
                                            </div>
                                            <div class="small__product--content">
                                                <h3 class="small__product--card__title"><a href="product-details.html">Nost nobis are! </a></h3>
                                                <div class="small__product--card__price">
                                                    <span class="current__price">$220.52</span>
                                                </div>
                                                <ul class="rating small__product--rating d-flex">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="small__product--card d-flex">
                                            ...
                                            <div class="small__product--content">
                                                <h3 class="small__product--card__title"><a href="product-details.html">Volup quasi illo. </a></h3>
                                                <div class="small__product--card__price">
                ...
                <div class="row">
                            ...
                            <div class="row  mb--n30">
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="banner__items position__relative">
                                        <a class="banner__thumbnail display-block" href="{{url('shop')}}"><img class="banner__thumbnail--img banner__max--height" src="assets/img/banner/banner5.webp" alt="banner-img">
                                ...
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="banner__items position__relative">
                                        <a class="banner__thumbnail display-block" href="{{url('shop')}}"><img class="banner__thumbnail--img banner__max--height" src="assets/img/banner/banner6.webp" alt="banner-img">
                                            <div class="banner__content style__right">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="banner__sidebar position__relative">
                            <a class="banner__thumbnail display-block" href="{{url('shop')}}"><img class="banner__thumbnail--img" src="assets/img/banner/banner4.webp" alt="banner-img">

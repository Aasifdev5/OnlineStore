                                    ...
                                    document.getElementById('price-filter-form').addEventListener('submit', function(e) {
                                        ...
                                        .then(data => {
                                            ...
                                            data.products.forEach(product => {
                                                ...
                                                productElement.className = 'col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30'; // Adjust classes as needed
                                                productElement.innerHTML = `
                                                    <article class="product__card">
                                                        <div class="product__card--thumbnail">
                                                            <a class="product__card--thumbnail__link display-block" href="${product.url}" data-product-id="${product.id}">
                                                                <img class="product__card--thumbnail__img product__primary--img" src="${product.thumbnail}" alt="Product Image">
                                                                <img class="product__card--thumbnail__img product__secondary--img" src="${product.thumbnail}" alt="Product Image">
                                                            </a>
                                                            <ul class="product__card--action d-flex align-items-center justify-content-center">
                                                                ${product.isVariation ? '' : `
                                                                    <li class="product__card--action__list">
                                                                        <a class="product__card--action__btn" title="Wishlist" href="${product.addToWishlistUrl}">
                                                        ...
                                                        <div class="product__card--content">
                                                            <h3 class="product__card--title"><a href="${product.detailsUrl}" data-product-id="${product.id}">${product.title}</a></h3>
                                                            ...
                                                            <div class="product__card--footer">
                                                                ${product.isVariation ? '' : `
                                                                    <a class="product__card--btn primary__btn" href="${product.addToCartUrl}">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    ...
                                    @foreach ($brands as $row)
                                        <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">
                                                {{ $row->name }}
                                            </a></li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="shop__right--sidebar">
                            ...
                            <div class="categories__shop mb-50">
                                <div class="section__heading border-bottom mb-30">
                                    <h2 class="section__heading--maintitle">COMPRAR POR CATEGORÍAS</h2>
                                </div>
                                ...
                                <div class="shop__header d-flex align-items-center justify-content-between mb-30">
                                    <div class="product__view--mode d-flex align-items-center">
                                        ...
                                        <div class="product__view--mode__list product__short--by align-items-center d-flex">
                                            <label class="product__view--label">Ordenar por :</label>
                                            <div class="select shop__header--select">
                                                <select class="product__view--select">
                                                    <option selected value="1">Ordenar por último</option>
                                                    <option value="2">Ordenar por popularidad</option>

                                                    <option value="4">Ordenar por calificación </option>
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                        <article class="product__card">
                                                            ...
                                                            <div class="product__card--content">
                                                                ...
                                                                <div class="product__card--price">
                                                                    <span
                                                                        class="current__price">{{ 'BS ' . $price }}</span>
                                                    ...
                                                    <div class="col mb-30">
                                                        <div class="product__card product__list d-flex align-items-center">
                                                            ...
                                                            <div class="product__card--content product__list--content">
                                                                <h3 class="product__card--title"><a
                                                                        href="{{ url('product-details') }}{{ '/' . $row->slug }}"
                                                                        data-product-id="{{ $row->id }}">{{ $row->title }}
                                                                    </a></h3>

                                                                <div class="product__list--price">
                                                                    <span class="current__price">{{ 'BS ' . $price }}
                                                                    </span>

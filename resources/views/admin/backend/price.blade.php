						...
						<div class="col-lg-3" style="margin-top: 25px;">
                            <div class="card">
                                ...
                                <ul class="nav flex-column nav-pills" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="price-tab" data-toggle="tab" href="{{ route('backend.price') }}" role="tab" aria-controls="price" aria-selected="false"><i class="fa fa-money"></i> {{ __('Discount Manage') }}</a>
                                    </li>
                                    <li class="nav-item">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input  name="sale_price" id="sale_price" type="text" class="form-control parsley-validated" data-required="true">
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											<label for="old_price">{{ __('Old Price') }}</label>
											<input  name="old_price" id="old_price" type="text" class="form-control">
										</div>
									</div>
								</div>
								<div class="row">

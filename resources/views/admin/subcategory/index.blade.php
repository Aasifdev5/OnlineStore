                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                <a href="{{route('subcategory.edit', [$subcategory->uuid])}}" title="Edit"
                                                    class="btn btn-icon waves-effect waves-light btn-success m-b-5 m-r-5"
                                                    data-toggle="tooltip"> <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="javascript:void(0);" class="btn btn-icon waves-effect waves-light btn-danger m-b-5 delete-subcategory"
        ...
        if (confirm('{{ trans('do you want to delete') }}')) { // Confirmation dialog
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    toastr.error("Failed to delete subcategory. Please try again later."); // Notify user of failure
                }
            });
        } else {

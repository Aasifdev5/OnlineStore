                ...
                <div class="col-xl-9 col-lg-8 shop-col-width-lg-8">
                    <div class="shop__right--sidebar">
                        ...
                        <div class="categories__shop mb-50">
                         ...
                         <style>
    .categories__shop--card__link:hover {
        background-color: yellow;
        color: black;
    }

    .categories__shop--card__link:hover .categories__content--title,
    .categories__shop--card__link:hover .categories__content--subtitle {
        color: black;
    }
</style>
...
if (in_array($category, $allCategoryIds)) {
    ...
    @foreach ($categories as $parentCategory)
        <li class="categories__shop--card" style="width: 150px; height: 150px; display: flex; flex-direction: column; justify-content: space-between;">
            <a class="categories__shop--card__link" href="{{ url('productbySubCategory') }}/{{ $category }}/{{ $parentCategory->id }}"
               style="display: block; text-decoration: none; transition: background-color 0.3s ease, color 0.3s ease; height: 100%; text-align: center;">
                <div class="categories__thumbnail mb-15" style="display: flex; justify-content: center; align-items: center; height: 50px; width: 50px; margin: 0 auto;">
                    <img class="categories__thumbnail--img" src="{{ asset($parentCategory->og_image) }}" style="max-height: 100%; max-width: 100%;" alt="categories-img">
                </div>
                <div class="categories__content" style="flex-grow: 1;">
                    <h2 class="categories__content--title" style="font-size: 12px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; transition: color 0.3s ease;">
                        {{ $parentCategory->name }}
                    </h2>
                    <span class="categories__content--subtitle" style="font-size: 10px; transition: color 0.3s ease;">
                        @php
                                                ...
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="{{ url('product-details') }}/{{ $row->slug }}" data-product-id="{{ $row->id }}">
                                                            ...
                                                            @if(!empty($IsVariation) && !is_null($IsVariationProductDetails))
